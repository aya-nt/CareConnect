...
const mockHistory = [
  { id: 1, type: "status", message: "Feeling Great", time: "2 hours ago", status: "delivered" },
  { id: 2, type: "emergency", message: "Emergency Alert", time: "Yesterday, 3:45 PM", status: "responded" },
  { id: 3, type: "medical", message: "Medical Help Needed", time: "Yesterday, 11:20 AM", status: "responded" },
  { id: 4, type: "food", message: "Food Request", time: "2 days ago", status: "delivered" },
  { id: 5, type: "comfort", message: "Comfort Check", time: "2 days ago", status: "delivered" },
]
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="max-w-md mx-auto space-y-6 pb-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">Your recent alerts and status updates</p>
        </div>
